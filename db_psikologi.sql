...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 17, 2023 at 10:18 AM
...
(18, 'test', 'test', 'test@gmail.com', 'Perempuan', '2003-12-25', 'Major', '0.713');
...
(2, 'test@gmail.com', 'test', 'test', 'test', 'Perempuan', '2003-12-25', 'jakarta');
...
--
ALTER TABLE `konsultasi`
  MODIFY `Idpasien` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT for table `soal`
--
ALTER TABLE `soal`
  MODIFY `Soalid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
